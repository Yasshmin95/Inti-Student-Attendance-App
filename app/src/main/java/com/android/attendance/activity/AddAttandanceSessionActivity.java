...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] yearString = new String[] {"YI","Y2","Y3"};
	private String[] subjectSEString = new String[] {"DM","STA"};
	private String[] subjectTEString = new String[] {"NW","OS"};
	private String[] subjectBEString = new String[] {"SM","DAR"};

	private String[] subjectFinal = new String[] {"HT","HCI","SP","TCS","AGI","AI"};
